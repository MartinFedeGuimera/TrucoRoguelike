...
A roguelike deck-building game based on the traditional Argentine card game **Truco**.

Combine strategy, bluff, and powerful relics to defeat your opponents in a run-based progression system.
...
```
2. Open the project with Godot 4 .NET
